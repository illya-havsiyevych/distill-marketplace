...
- **kept** — the sources, with their spans, support the bullet as written, and the result serves the title. A result with no `sources:` line rests on the original alone; keep it if nothing better-supported in the file contradicts it.
